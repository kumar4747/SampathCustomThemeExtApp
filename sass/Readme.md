...
folder are mapped to the application's root namespace, 'SampathCustomThemeApp'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SampathCustomThemeApp"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SampathCustomThemeApp' in the same way
as `"SampathCustomThemeApp/sass/src"`.
